...
class ContactosControllerTest < ActionController::TestCase
  ...
  test "should create contacto" do
    assert_difference('Contacto.count') do
      post :create, contacto: { Apellido: @contacto.Apellido, Nombre: @contacto.Nombre, Telefono: @contacto.Telefono }
    end
  ...
  test "should update contacto" do
    patch :update, id: @contacto, contacto: { Apellido: @contacto.Apellido, Nombre: @contacto.Nombre, Telefono: @contacto.Telefono }
    assert_redirected_to contacto_path(assigns(:contacto))
  end
