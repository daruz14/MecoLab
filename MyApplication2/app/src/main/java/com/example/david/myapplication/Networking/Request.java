package com.example.david.myapplication.Networking;
...
public abstract class Request {
    public static final String API_URL = "http://192.168.1.151:3000/";
    public static final String GET = "GET";
    public static final String POST = "POST";
    public static final String AUTHORIZATION = "Authorization";
    public static final String TOKEN_HEADER = "Token token=";
    public static final String CONTENT_TYPE = "Content-Type";
    public static final String APPLICATION_JSON = "contactos.json";
